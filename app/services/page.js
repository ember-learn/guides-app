...
export default Service.extend({
  ...
  currentSection: computed(
    ...
    function() {
      ...
      if (!tocSections || !contentId) {
        return;
      }

      let section = contentId.split('/')[0];
      let currentSection = tocSections.find(
        tocSection => tocSection.id === section
      );
  ...
  currentPage: computed(
    ...
    function() {
      ...
      let currentPage = pages.find(
        page => page.url === get(this, 'content.id')
      );
